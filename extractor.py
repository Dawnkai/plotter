...
class Extractor:
    ...
    def __init__(self, limit_x = 218, limit_y = 121, filepath = "", thresh_low = 100, thresh_high = 200):
    ...
    def get_contours(self):
        ...
        """
        self.load_image()
        _, contours, _ = cv2.findContours(image=self.edges, mode=cv2.RETR_TREE, method=cv2.CHAIN_APPROX_NONE)
        return contours
